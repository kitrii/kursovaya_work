...
public class PortfolioController {
    ...
    @GetMapping("/owner")
    private ResponseEntity<List<BondEntity>> getBondsByOwnerId(@RequestParam(name = "ownerId") String ownerId) {
        List<BondEntity> DbBonds = portfolioService.getBondsByOwnerId(ownerId);
    ...
    private ResponseEntity<Float> calculateDurationByOwnerId(@RequestParam(name = "ownerId") String ownerId) {
        List<BondEntity> portfolioBonds = portfolioService.getBondsByOwnerId(ownerId);
